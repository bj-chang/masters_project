"""Test that the plain Python P1 Poisson solver converges at rate 2.

Direct port of the convergence test pattern from
test_12_poisson_convergence.py in the course package. We expect P1
elements to give a rate close to 2 in the L2 norm.
"""
